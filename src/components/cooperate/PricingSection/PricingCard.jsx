const PricingCard = ({ title, price, unit, features, isHighlighted = false }) => {
  return (
    <article
      className={`pricing-card bg-white rounded-2xl p-4 notebook:px-20 notebook:py-12 flex flex-col w-full min-w-[calc(100vw-96px)] shrink-0 notebook:min-w-0 scroll-snap-start ${
        isHighlighted ? 'border-2 border-neutral-700' : 'border-none shadow-[inset_0_0_0_1px_rgba(0,0,0,0.06)]'
      }`}
    >
