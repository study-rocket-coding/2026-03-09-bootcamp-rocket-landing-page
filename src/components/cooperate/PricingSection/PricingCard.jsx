...
const PricingCard = ({ title, price, unit, features, isHighlighted = false }) => {
  ...
  return (
    <Card
      className={cn(
        'bg-white rounded-2xl p-4 notebook:px-20 notebook:py-12 flex flex-col w-full min-w-[calc(100vw-96px)] shrink-0 notebook:min-w-0 scroll-snap-start',
    ...
    >
      ...
      <CardContent className="p-0 flex flex-col gap-6">
        <div className="card-price bg-neutral-200 py-7 px-6 flex items-baseline justify-center gap-2">
