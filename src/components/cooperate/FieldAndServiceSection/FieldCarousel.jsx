...
const FieldCarousel = ({ images }) => {
  return (
    <>
      {/* Carousel 輪播組件 (桌機版) */}
      <Carousel className="carousel-container hidden notebook:flex gap-6 overflow-x-auto snap-x snap-mandatory mt-15 scrollbar-none">
        {images.map((img, idx) => (
      ...
      {/* Carousel 手機版 (Mobile) */}
      <Carousel className="carousel-container-mb flex notebook:hidden gap-4 overflow-x-auto snap-x snap-mandatory mt-10 px-4 scrollbar-none">
        {images.map((img, idx) => (
