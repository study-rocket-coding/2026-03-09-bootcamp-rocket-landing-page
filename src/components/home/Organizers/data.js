...
export const organizersData = [
  { src: rocket, role: '主辦單位', name: '火箭隊' },
  { src: hexschool, role: '協辦單位', name: '六角學院' },
  { src: goodidea, role: '協辦單位', name: '好想工作室' },
  { src: kdan, role: '合作招募廠商', name: '凱鈿行動科技' },
  { src: titan, role: '合作招募廠商', name: '鈦坦科技' },
  { src: skw, role: '合作招募廠商', name: '坂和企業' },
  { src: wistron, role: '合作招募廠商', name: '緯創資通' },
];