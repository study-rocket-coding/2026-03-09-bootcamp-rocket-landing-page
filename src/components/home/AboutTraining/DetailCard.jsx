...
const DetailCard = ({ title, about, requirement, learn, src, isReverse }) => {
  ...
  return (
    <Card className={cn(
      "ring-0 border-2 border-neutral-200 shadow-none rounded-none overflow-visible",
      "mt-8 flex flex-col !bg-neutral-0 bg-training-pattern",
      "pt-0 pb-8 pl-12 pr-12 md:rounded-2xl md:pl-12 md:pr-20 md:pb-10"
    )}>
      <CardContent className="p-0 flex flex-col">
        ...
        <div className={cn(
          "flex flex-col-reverse gap-7 md:gap-12 lg:gap-24",
          dynamicStyles
        )}>
