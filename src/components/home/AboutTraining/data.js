...
export const trainings = [
  {
    ...
    about: {
      title: '關於前端',
      content:
        '主要專精 JavaScript 前端 (65%)、後端 (35%) 開發，投入語言為 HTML、CSS、JavaScript，<span class="font-bold bg-gradient-to-t from-accent-yellow from-50% to-transparent to-50%">適合有一些 HTML、CSS、JS 基礎的學員報名</span>。',
    },
    requirement: {
      title: '應徵門檻',
      items: [
  ...
  },
  {
    ...
    about: {
      title: '關於後端',
      content:
        '後端工程師組主要專注為後端開發，投入後端語言為<span class="font-bold bg-gradient-to-t from-accent-yellow from-50% to-transparent to-50%"> C#、.Net，適合無程式背景的學員報名</span>。',
    },
    learn: {
      title: '你會學到',
      skills: [
  ...
  },
  {
    ...
    about: {
      title: '關於設計',
      content:
        '主要以網頁 UI 設計 50%、網頁前端 50% 的雙技能樹養成，<span class="font-bold bg-gradient-to-t from-accent-yellow from-50% to-transparent to-50%">適合具備視覺背景，操作過繪圖軟體尤佳，歡迎無工作經驗的學員報名</span>。',
    },
    learn: {
      title: '你會學到',
      skills: [
