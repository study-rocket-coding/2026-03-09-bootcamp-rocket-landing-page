...
export const row1 = [
  { src: case1, alt: 'case-1' },
  { src: case2, alt: 'case-2' },
  { src: case3, alt: 'case-3' },
  { src: case4, alt: 'case-4' },
];

export const row2 = [
  { src: case5, alt: 'case-5' },
  { src: case6, alt: 'case-6' },
  { src: case7, alt: 'case-7' },
  { src: case8, alt: 'case-8' },
];
